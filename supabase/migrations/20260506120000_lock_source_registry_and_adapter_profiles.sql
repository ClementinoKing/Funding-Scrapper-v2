...
from jsonb_to_recordset($$[
  ...
  },
  {
    ...
    "adapter_key": "pic",
    "seed_urls": ["https://www.pic.gov.za/", "https://www.pic.gov.za/isibaya", "https://www.pic.gov.za/apply-for-funding/isibaya"],
    "active": true,
    "notes": ["Aliases: Public Investment Corporation."],
    "adapter_config": {
      "allowed_path_prefixes": ["/isibaya", "/isibaya/", "/early-stage-fund", "/early-stage-fund/", "/unlisted-investments", "/unlisted-investments/", "/properties", "/properties/", "/apply-for-funding", "/apply-for-funding/"],
      "default_seed_urls": ["https://www.pic.gov.za/", "https://www.pic.gov.za/isibaya", "https://www.pic.gov.za/apply-for-funding/isibaya", "https://www.pic.gov.za/early-stage-fund", "https://www.pic.gov.za/properties", "https://www.pic.gov.za/pic/site/site-map"],
