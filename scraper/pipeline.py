            ...
            return AIClassifier(
                {
                    ...
                    "aiMaxCallsPerFunder": self.settings.ai_max_calls_per_funder,
                    "aiMaxCallsPerRun": self.settings.ai_max_calls_per_run,
                    "aiMaxPdfCallsPerFunder": self.settings.ai_max_pdf_calls_per_funder,
